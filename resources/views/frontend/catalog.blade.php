...
<html lang="en">
  ...
  <body>
    ...
    <!----------------------------------catalog section ----------->
 <section class="container">
  <div class="cartsectiionstart">
    <div class="cartsectiionstart_container  d-flex  justify-content-around py-2">
      <div class="cartsectiionstart_container_leftsection d-flex align-items-end justify-content-around py-3">
        <div>
          <img src="../image/productpage/honeybottle.png" alt="">
        </div>
        <div>
          <h5 class="text-center ">Product name</h5>
          <div class="incres_dec">
            <span class="">Quantity</span>
            <i class="fa-solid fa-plus"></i>
            <span class="" id="increaseQuality">0</span>
        ...
        <span class="">Rs:30</span>
        <i class="fa-solid fa-trash-can "></i>


      </div>
      <div class="cartsectiionstart_container_rightsection">
        <h4 class="">Order Summary</h4>
        <span class="summaryline"></span>
        <div class="d-flex  d-flex justify-content-between py-2">
          <h5>items Charge</h5>
          <h5>400</h5>
        </div>
        ...
        <button type="button" class="buybutton py-2 col-12">Buy now</button>
  ...
  <script>
    const incQty = document.getElementById("");
  </script>
</html>
