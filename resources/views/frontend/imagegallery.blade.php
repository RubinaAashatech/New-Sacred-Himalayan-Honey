...
<html lang="en">
  ...
  <body>
    ...
    <section class="container">
      <div class="startofgallerypage py-5">
        ...
        <div
          class="row wrap d-flex justify-content-between particularimagesection"
        >
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
          >
            <img src="../image/blog/blogheroimage.png" alt="Main Image" />
            <span class="imagetitle">Image Title</span>
          </div>
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
          >
            <img src="../image/gallery/image/second.png" alt="s" />
            <span class="imagetitle">image title</span>
          </div>
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
          >
            <img src="../image/gallery/image/thirds.png" alt="s" />
            <span class="imagetitle">image title</span>
          </div>
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
          >
            <img src="../image/gallery/image/fourth.png" alt="s" />
            <span class="imagetitle">image title</span>
          </div>
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
          >
            <img src="../image/gallery/image/fifth.png" alt="s" />
            <span class="imagetitle">image title</span>
          </div>
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
          ...
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
          >
            <img src="../image/gallery/image/first.png" alt="s" />
            <span class="imagetitle">image title</span>
          </div>
          <div
            class="col-md-3 grid-item d-flex flex-column align-items-center customgallery"
  ...
  <!-- <a href="images/image1.jpg" data-lightbox="gallery" data-title="Image 1">
    <img src="thumbnails/thumb1.jpg" alt="Image 1">
  </a>

  <a href="images/image2.jpg" data-lightbox="gallery" data-title="Image 2">
    <img src="thumbnails/thumb2.jpg" alt="Image 2">
  </a>

  <a href="images/image3.jpg" data-lightbox="gallery" data-title="Image 3">
    <img src="thumbnails/thumb3.jpg" alt="Image 3">
  </a> -->
